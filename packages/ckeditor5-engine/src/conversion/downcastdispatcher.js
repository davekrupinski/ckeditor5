...
export default class DowncastDispatcher {
	 ...
	 * @param {module:engine/view/downcastwriter~DowncastWriter} writer The view writer that should be used to modify the view document.
	 * @param {Object} [options] An additional data passed to the converters through
	 ...
	 * @param {module:engine/view/downcastwriter~DowncastWriter} writer View writer that should be used to modify view document.
	 * @param {Object} [options] Additional data passed to the converters through
	 * {module:engine/conversion/downcastdispatcher~DowncastConversionApi conversion api}. Used only with `dataDowncast` group.
	 */
...
/**
 * An object with additional configuration used during conversion. Available only for `dataDowncast` group.
 *
