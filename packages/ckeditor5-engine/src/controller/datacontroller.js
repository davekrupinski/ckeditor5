...
export default class DataController {
	 ...
	 * @param {Object} [options.conversionOptions] Additional options passed to the conversion process.
	 ...
	 * @param {Object} [conversionOptions] Additional configuration passed to the conversion process.
	 * @returns {String} Output data.
	 */
